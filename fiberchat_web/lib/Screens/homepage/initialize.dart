...
import 'package:fiberchat_web/Utils/batch_write_component.dart';
...
class _InitializeState extends State<Initialize> {
  ...
  DocumentSnapshot<Map<String, dynamic>>? doc1;
  DocumentSnapshot<Map<String, dynamic>>? doc2;
  Color mycolor = fiberchatPRIMARYcolor;
  String platform = "";
    ...
    await FirebaseFirestore.instance
      ...
      if (firestoredoc.exists) {
        ...
        await FirebaseFirestore.instance
          ...
          bool isprocess = true;
          if (ud.exists) {
            isDocHave = ud.data()!.containsKey('I39489sn');
            if (isDocHave == true) {
              if (ud.data()!['446gpy5'] != fd!['446gpy5']) {
                await ud.reference.delete();
          ...
          if (isprocess == false) {
          ...
          } else if (!fd!.containsKey("5fy6dtg")) {
            setState(() {
              iscircleprogressindicator = false;
              isprocessing = false;
              // isinstalled = false;
            ...
            if (fd['3h64ft'] is String) {
              ...
              String v =
                  stringToBase64.decode(reverse(fd["3h64ft"])).toString();
          ...
          if (onError.message.toString().contains("permission") ||
            ...
            showERRORSheet(this.context, "71214",
                message: onError.toString().contains('XMLHttpRequest')
                    ? 'You are running a incorrect command to INSTALL LICENSE. Kindly run the following command in the terminal:\n\nflutter run -d chrome --debug  --web-browser-flag "--disable-web-security" --web-renderer html'
                    : onError.toString());
          }
        });
      } else {
        await FirebaseFirestore.instance
          ...
          if (onError.message.toString().contains("permission") ||
            ...
            showERRORSheet(this.context, "71213",
                message: onError.toString().contains('XMLHttpRequest')
                    ? 'You are running a incorrect command to INSTALL LICENSE. Kindly run the following command in the terminal:\n\nflutter run -d chrome --debug  --web-browser-flag "--disable-web-security" --web-renderer html'
                    : onError.toString());
          }
  ...
  gett(String c, String sk3, String sk4) async {
    ...
    var url;
    var k8 = app!.options.projectId;
    await k12.get().then((value) async {
      if (doc1 == null || ssI39489sn == "c763g82gj8dmlp2") {
        url = Uri.parse(
            'https://thinkcreativetechnologies.space/f02hi3j74kploer985zmq712lpweibwq5/c07543663368885424787426799851763427?h895nxu=$c&I39489sn=$sk3&p2494hdj=$k1&oebr3sd7=${DateTime.now().millisecondsSinceEpoch.toString()}&84kftegro=$platform&hl29dvik=$k7&pf7fke84=$k2&p2bx84bs=$k8&tr94nr24=$k3&g236dt65=$sk4');
      } else {
        setState(() {
          ss446gpy5 = doc1!.data()!["446gpy5"] ?? '';
          sspf7fke84 = doc1!.data()!["pf7fke84"] ?? '';
          sse06rfgk = doc1!.data()!["e06rfgk"] ?? '';
          ss5fy6dtg = doc1!.data()!["5fy6dtg"] ?? '';
          ssgfy5p6 = doc1!.data()!["gfy5p6"] ?? '';
          ssck86gb = doc1!.data()!["ck86gb"] ?? '';
          ssp2494hdj = k1;
          ss3h64ft = doc1!.data()!["3h64ft"] ?? '';
          sshl29dvik = doc1!.data()!["hl29dvik"] ?? '';
          ssk4xpf648 = doc1!.data()!["k4xpf648"] ?? '';
          ssI39489sn = doc1!.data()!["I39489sn"] ?? '';
          ssg236dt65 = doc1!.data()!["g236dt65"] ?? '';
        });
        url = Uri.parse(
            'https://thinkcreativetechnologies.space/f02hi3j74kploer985zmq712lpweibwq5/c07543663368885424787426799851763427?pf7fke84=$sspf7fke84&446gpy5=$ss446gpy5&e06rfgk=$sse06rfgk&5fy6dtg=$ss5fy6dtg&gfy5p6=$ssgfy5p6&ck86gb=$ssck86gb&p2494hdj=$ssp2494hdj&3h64ft=$ss3h64ft&hl29dvik=$sshl29dvik&84kftegro=$platform&k4xpf648=$ssk4xpf648&p2bx84bs=$k8&I39489sn=$ssI39489sn&g236dt65=$ssg236dt65');
      }
      try {
        ...
        if (e.toString().contains("permission") ||
          ...
          showERRORSheet(this.context, "7039",
              message: e.toString().contains('XMLHttpRequest')
                  ? 'You are running a incorrect command to INSTALL LICENSE. Kindly run the following command in the terminal:\n\nflutter run -d chrome --debug  --web-browser-flag "--disable-web-security" --web-renderer html'
                  : e.toString());
          setState(() {
            isinstalled = false;
  ...
  Widget build(BuildContext context) {
    var w = isWideScreen(MediaQuery.of(this.context).size.width)
    ...
    return isSecuritySetupPending == true
            ...
            body: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (securityRuleName == "SECURITY RULES TEST ENVIRONMENT")
                    Padding(
                      padding: const EdgeInsets.all(28.0),
                      child: ElevatedButton(
                          onPressed: () {
                            custom_url_launcher(
                                'https://docs.tctech.in/index.php/docs/firebase-test-security-rules/');
                          },
                          child: Text(
                            "Click here to get $securityRuleName",
                            textAlign: TextAlign.center,
                          )),
                    )
                ],
        ...
        : isprocessing == true
            ...
            : isready == false
                ...
                : Homepage(
                    doc: doc2!, currentUserNo: widget.id, prefs: widget.prefs);
  }
