...
import 'package:fiberchat_web/Screens/recent_chats/widgets/getBroadcastMessageTile.dart';
import 'package:fiberchat_web/Screens/recent_chats/widgets/getGroupMessageTile.dart';
    ...
    return Fiberchat.getNTPWrappedWidget(ScopedModel<DataModel>(
      ...
      child:
        ...
        return Scaffold(
          ...
          floatingActionButton: isWideScreenMode == true
              ? null
              : Padding(
