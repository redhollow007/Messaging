...
import 'package:fiberchat_web/widgets/Passcode/circle.dart';
import 'package:fiberchat_web/widgets/Passcode/keyboard.dart';
import 'package:fiberchat_web/widgets/Passcode/shake_curve.dart';
...
class _PasscodeScreenState extends State<PasscodeScreen>
              ...
              child: Container(
                ...
                child: Keyboard(
                  ...
                  keyboardUIConfig: widget.keyboardUIConfig != null
                      ...
                      : KeyboardUIConfig(
                          primaryColor: fiberchatBlack,
                          digitTextStyle:
                              TextStyle(fontSize: 30, color: fiberchatBlack)),
                ),
              ),
            ),
            _isValid == true
  ...
  List<Widget> _buildCircles() {
    ...
    var config = widget.circleUIConfig != null
        ...
        : CircleUIConfig(
            fillColor: fiberchatBlack,
            borderColor: fiberchatBlack,
          );
